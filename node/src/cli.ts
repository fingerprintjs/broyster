...
import { errorStack } from './internal/errors.js'
import { isPositiveInteger, parseCsv } from './internal/validation.js'
...
async function main(): Promise<void> {
  ...
  const summary = await runBrowserStackTests({
    ...
    browsers: values.browsers === undefined ? undefined : parseCsv(values.browsers),
    filter: values.filter,
    concurrency,
    buildName: values.build,
    resultsFile: values.results,
