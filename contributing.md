...
- The changes should be backward compatible where applicable.
...
First, make sure you have [Git](https://git-scm.com), [Node.js](https://nodejs.org) and [pnpm](https://pnpm.io) installed.
...
To run the tests in browsers on [BrowserStack](https://www.browserstack.com), get a BrowserStack access key, a Cloudflare tunnel token, and run:
